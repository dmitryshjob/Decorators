...
def logger(old_function):
    ...
    def new_function(*args, **kwargs):
        ...
        print(f'вызвана функция {old_function = } с аргументами {args = } и {kwargs = }')
        ...
        print(f'результат из функции {old_function} => {x}')
...
# Должен получиться декортор, который записывает в файл
